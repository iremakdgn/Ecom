            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="welcome_text">
                        <p>Güvenli Alışverişin adresi LittleCoffeeShop.com</p>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="top_right text-right">
                        <ul>
                           ...
                           oturum_secenek();
                            ...
                            <li class="language"><a href="#"> Türkçe <i
                                            class="ion-chevron-down"></i></a>
                                <ul class="dropdown_language">
                                    <li><a href="#"><img src="assets/img/logo/cigar.jpg" alt=""> French</a></li>
                                    <li><a href="#"><img src="assets/img/logo/language2.png" alt="">English</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-4">
                    <div class="logo">
                        <a href="index.php"><img src="assets/img/logo/littlecoffee.png" alt=""></a>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-3">
                    <div class="cart_area">
                        ...
                        <div class="cart_link">
                            <a href="#"><i class="ion-ios-cart-outline"></i>Sepetim</a>
                            <?php
                            mini_cart_count();
                            ?>                            <!--mini cart-->
                            <div class="mini_cart">
                                ...
                                <ul>
                                    <li><a href="index.html">Anasayfa</a>
                                        <ul>
                                            ...
                                            <li><a href="index-3.html">Anasayfa 3</a></li>
                                            <li><a href="index-4.html">Anasayfa 4</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="shop.html">Alışveriş</a>
                                        <ul>
