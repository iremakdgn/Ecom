                    ...
                    <ul class="nav" role="tablist">
                        <li>
                            <a class="active" data-toggle="tab" href="#Products" role="tab" aria-controls="Products"
                               aria-selected="true">Yeni Ürünler</a>
                        </li>
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-12">
                            <div class="modal_right">
                                <div class="modal_title mb-10">
                                    <h2>Filtre Kahve Makinesi</h2>
                                </div>
                                <div class="modal_price mb-10">
                                    <span class="new_price">299.99 TL</span>
                                    <span class="old_price">350.99 TL</span>
                                </div>
                                <div class="modal_content mb-10">
                                    <p>1200 watt <br>
									

12 fincan / 1.5 Litre cam hazne <br>

Paslanmaz bantlı şık tasarım <br>

Mavi ledli şık tasarım <br>

2 saat sonra kendiliğinden kapanma <br>

Görünür su seviyesi <br>

Sıcak tutulan cam hazne</p>
                                </div>
