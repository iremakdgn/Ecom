...
<head>
        ...
        <title>Little Coffee - paq page</title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="faq_content_wrapper">
                                <h4>
Aşağıda sıkça sorulan sorular, cevapları kendiniz bulabilirsiniz.</h4>
                            ...
                            <div class="col-lg-4 col-md-8">
                                <div class="single_footer">
                                    ...
                                    <div class="footer_desc">
                                        <p>Biz kahvenin en kaliteli halini yaratan tasarımcı ve geliştiricilerden oluşan bir ekibiz.</p>
                                    </div>
                                    <div class="footer_contact">
                                        <ul>
                                            <li><i class="ion-location"></i> İstanbul,Türkiye</li>
                            ...
                            <div class="col-lg-2 col-md-4">
                                <div class="single_footer">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="#">Önceki Siparişler</a></li>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-md-6">
                                <div class="copyright_content">
                                    <p>Copyright &copy; 2018, <a href="#">Little Coffee</a>. All Rights Reserved</p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
